...
function Contact() {
    ...
    let handleSubmit = async (e) => {
        ...
        try {
            await axios.post(`${env.api}/contact`, { message: details });
            setStatus("Submit")
            setName("")
            setLastName("")
            setEmail("")
            ...
            <div className="container text-center col col-lg-6 mt-4" data-aos="zoom out">
                ...
                <div className="contact_box text-center col-lg-12 mt-4" data-aos="zoom-out">
                    ...
                    <div className="contact_icons col">
                        <div className="row">
                            <div className="col-lg-6">
                                <a href="https://github.com/Akshada13" target="_blank" rel="noreferrer noopener"><i class="fab fa-github"></i></a>
                            </div>
                            <div className="col col-lg-6">
                                <a href="https://www.linkedin.com/in/akshada-shelke-a65608117" target="_blank" rel="noreferrer noopener"><i class="fab fa-linkedin"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
